        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group p-7 bg-[#141414] border border-[#262626] hover:border-[#e8e8e8]/30 rounded-xl transition-all duration-300"
            >
              <div className="inline-flex p-3 bg-[#1c1c1c] border border-[#333] rounded-lg mb-5 text-white group-hover:text-white transition-colors">
                {feature.icon}
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                ...
                className="p-4 bg-[#1c1c1c] border border-[#262626] hover:border-[#e8e8e8]/30 rounded-lg text-center transition-colors"
              >
